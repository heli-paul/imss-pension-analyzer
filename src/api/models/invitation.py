...
class Invitation(Base):
    ...
    Attributes:
        ...
        initial_credits: Créditos iniciales a otorgar (NUEVO)
        credits_valid_days: Días de validez de créditos (NUEVO)
    ...
    initial_credits = Column(Integer, default=10, nullable=False)
    credits_valid_days = Column(Integer, default=30, nullable=False)
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "credits_valid_days": self.credits_valid_days,
    ...
    def __repr__(self):
        return f"<Invitation(email='{self.email}', status='{self.status}', credits={self.initial_credits})>"
